...
public abstract class Conta {
	...
	public void tirarExtrato() {
		System.out.println("\n******************* EXTRATO CONTA ******************\n");
		System.out.println("Conta N° " + this.getNumero());
		System.out.println("Agencia N° " + this.getAgencia().getNumero());
		...
		System.out.println("Saldo Final: R$" + String.format("%.2f", this.saldo));
		System.out.println("\n****************************************************\n");
	}
